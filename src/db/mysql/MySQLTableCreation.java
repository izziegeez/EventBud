...
//create a new class called MySQLTableCreation.java to automatically reset our tables in our database. 
...
public class MySQLTableCreation {
	...
	public static void main(String[] args) {
		try {
			...
			// Step 3, create 4 tables: Users, Items, Category, History
